...
//        }
        ...
        if(name.isNotEmpty() && email.isNotEmpty() && confirmPassword.isEmpty() && nickname.isNotEmpty() && nickname.length<=10 && password.isNotEmpty()){
            val user = User(1, name, nickname, email, password,1)
