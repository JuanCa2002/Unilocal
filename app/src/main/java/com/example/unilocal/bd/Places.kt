...
object Places {
    ...
    init {
        val place1= Place(1,"Los cucos","Muy genial",1,true,2,48.3434f,82.455f,1)
        place1.schedules.add(horario2)

        val place2= Place(2,"Restaurante mariana","Muy genial",2,true,2,48.3434f,82.455f,2)
        place2.schedules.add(horario1)

        val place3= Place(3,"Cafe tigres","Muy genial",3,true,5,48.3434f,82.455f,3)
        place3.schedules.add(horario1)

        val place4= Place(4,"Hotel genial","Muy genial",1,true,1,48.3434f,82.455f,4)
        place4.schedules.add(horario3)

        val place5= Place(5,"Los zarpos","Muy genial",1,true,3,48.3434f,82.455f,2)
        place5.schedules.add(horario1)

        val place6= Place(6,"Mall","Muy genial",2,false,4,48.3434f,82.455f,5)
